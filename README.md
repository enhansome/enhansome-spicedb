...
* JVM
  ...
  * [quarkiverse/quarkus-authzed-client](https://github.com/quarkiverse/quarkus-authzed-client) ⭐ 8 | 🐛 11 | 🌐 Java | 📅 2026-09-14 - gRPC client integration for Quarkus
* PHP
...
* [gitpod-io/gitpod](https://github.com/gitpod-io/gitpod) ⭐ 13,772 | 🐛 452 | 🌐 TypeScript | 📅 2026-09-14 - GitPod's support for fine-grained authorization leverages SpiceDB
* [wolfi-dev/os](https://github.com/wolfi-dev/os/blob/main/spicedb.yaml) ⭐ 1,285 | 🐛 87 | 🌐 Shell | 📅 2026-09-14 - Container build toolchain that packages SpiceDB
...
* [infratographer/permissions-api](https://github.com/infratographer/permissions-api) ⭐ 11 | 🐛 38 | 🌐 Go | 📅 2026-09-11 - The default authorization strategy for Infratographer leverages SpiceDB
