...
* [jeanlouhallee/intellij-spicedb-plugin](https://github.com/jeanlouhallee/intellij-spicedb-plugin) ⭐ 3 | 🐛 1 | 🌐 Java | 📅 2026-09-21 - Community IntelliJ plugin for SpiceDB schema files
...
* [gitpod-io/gitpod](https://github.com/gitpod-io/gitpod) ⭐ 13,777 | 🐛 450 | 🌐 TypeScript | 📅 2026-09-21 - GitPod's support for fine-grained authorization leverages SpiceDB
* [wolfi-dev/os](https://github.com/wolfi-dev/os/blob/main/spicedb.yaml) ⭐ 1,291 | 🐛 89 | 🌐 Shell | 📅 2026-09-26 - Container build toolchain that packages SpiceDB
