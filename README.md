...
* [gitpod-io/gitpod](https://github.com/gitpod-io/gitpod) ⭐ 13,755 | 🐛 456 | 🌐 TypeScript | 📅 2026-08-17 - GitPod's support for fine-grained authorization leverages SpiceDB
* [wolfi-dev/os](https://github.com/wolfi-dev/os/blob/main/spicedb.yaml) ⭐ 1,275 | 🐛 84 | 🌐 Shell | 📅 2026-08-22 - Container build toolchain that packages SpiceDB
