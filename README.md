...
* [gitpod-io/gitpod](https://github.com/gitpod-io/gitpod) ⭐ 13,763 | 🐛 451 | 🌐 TypeScript | 📅 2026-09-03 - GitPod's support for fine-grained authorization leverages SpiceDB
* [wolfi-dev/os](https://github.com/wolfi-dev/os/blob/main/spicedb.yaml) ⭐ 1,284 | 🐛 83 | 🌐 Shell | 📅 2026-09-06 - Container build toolchain that packages SpiceDB
