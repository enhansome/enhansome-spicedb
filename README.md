...
* [gitpod-io/gitpod](https://github.com/gitpod-io/gitpod) ⭐ 13,771 | 🐛 451 | 🌐 TypeScript | 📅 2026-09-07 - GitPod's support for fine-grained authorization leverages SpiceDB
* [wolfi-dev/os](https://github.com/wolfi-dev/os/blob/main/spicedb.yaml) ⭐ 1,285 | 🐛 86 | 🌐 Shell | 📅 2026-09-13 - Container build toolchain that packages SpiceDB
