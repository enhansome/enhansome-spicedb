...
* Golang
  * [danhtran94/authzed-codegen](https://github.com/danhtran94/authzed-codegen) ⭐ 6 | 🐛 3 | 🌐 Go | 📅 2026-09-18 - Type-Safe stubs code generator for your AuthZed schemas
* .NET
...
* [umbrellaassociates/opa-spicedb](https://github.com/umbrellaassociates/opa-spicedb) ⭐ 27 | 🐛 0 | 🌐 Go | 📅 2025-10-11 - Third-party build of Open Policy Agent with a plugin to query SpiceDB
...
* [gitpod-io/gitpod](https://github.com/gitpod-io/gitpod) ⭐ 13,771 | 🐛 450 | 🌐 TypeScript | 📅 2026-09-18 - GitPod's support for fine-grained authorization leverages SpiceDB
* [wolfi-dev/os](https://github.com/wolfi-dev/os/blob/main/spicedb.yaml) ⭐ 1,287 | 🐛 87 | 🌐 Shell | 📅 2026-09-19 - Container build toolchain that packages SpiceDB
* [raystack/frontier](https://github.com/raystack/frontier) ⭐ 344 | 🐛 42 | 🌐 Go | 📅 2026-09-18 - Cloud-native, role-based user management system and authorization server for your applications and API endpoints
