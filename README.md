...
* [gitpod-io/gitpod](https://github.com/gitpod-io/gitpod) ⭐ 13,759 | 🐛 452 | 🌐 TypeScript | 📅 2026-08-24 - GitPod's support for fine-grained authorization leverages SpiceDB
* [wolfi-dev/os](https://github.com/wolfi-dev/os/blob/main/spicedb.yaml) ⭐ 1,278 | 🐛 83 | 🌐 Shell | 📅 2026-08-27 - Container build toolchain that packages SpiceDB
...
* [infratographer/permissions-api](https://github.com/infratographer/permissions-api) ⭐ 11 | 🐛 37 | 🌐 Go | 📅 2026-08-27 - The default authorization strategy for Infratographer leverages SpiceDB
