...
* [authzed-go](https://github.com/authzed/authzed-go) ⭐ 103 | 🐛 21 | 🌐 Go | 📅 2026-07-25 - Official client library for Go
* [authzed-node](https://github.com/authzed/authzed-node) ⭐ 62 | 🐛 44 | 🌐 TypeScript | 📅 2026-05-26 - Official client library for NodeJS in JavaScript/TypeScript
* [authzed-py](https://github.com/authzed/authzed-py) ⭐ 51 | 🐛 18 | 🌐 Python | 📅 2026-07-14 - Official client library for Python
...
* JavaScript/Typescript
  ...
  * [SchoolAI/spicedb-zed-schema-parser](https://github.com/SchoolAI/spicedb-zed-schema-parser) ⭐ 6 | 🐛 1 | 🌐 TypeScript | 📅 2026-05-19 - A tool to generate schema-aware typescript types and a type-safe wrapper for [authzed-node](https://github.com/authzed/authzed-node) ⭐ 62 | 🐛 44 | 🌐 TypeScript | 📅 2026-05-26
  * [quizizz/spicedb-wrapper](https://github.com/quizizz/spicedb-wrapper) ⭐ 0 | 🐛 2 | 🌐 TypeScript | 📅 2026-02-11 - Lightweight client wrapper of [authzed-node](https://github.com/authzed/authzed-node) ⭐ 62 | 🐛 44 | 🌐 TypeScript | 📅 2026-05-26
* JVM
...
* [zed](https://github.com/authzed/zed) ⭐ 163 | 🐛 50 | 🌐 Go | 📅 2026-08-07 - Official command-line tool for managing SpiceDB
* [SpiceDB Operator](https://github.com/authzed/spicedb-operator) ⭐ 105 | 🐛 40 | 🌐 Go | 📅 2026-07-22 - Official Kubernetes Operator for running SpiceDB
...
* [authzed/examples](https://github.com/authzed/examples) ⭐ 63 | 🐛 3 | 🌐 Python | 📅 2026-08-05 - Official examples repository
...
* [gitpod-io/gitpod](https://github.com/gitpod-io/gitpod) ⭐ 13,755 | 🐛 455 | 🌐 TypeScript | 📅 2026-08-12 - GitPod's support for fine-grained authorization leverages SpiceDB
* [wolfi-dev/os](https://github.com/wolfi-dev/os/blob/main/spicedb.yaml) ⭐ 1,266 | 🐛 83 | 🌐 Shell | 📅 2026-08-12 - Container build toolchain that packages SpiceDB
* [raystack/frontier](https://github.com/raystack/frontier) ⭐ 343 | 🐛 45 | 🌐 Go | 📅 2026-08-12 - Cloud-native, role-based user management system and authorization server for your applications and API endpoints
