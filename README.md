...
* Golang
  * [danhtran94/authzed-codegen](https://github.com/danhtran94/authzed-codegen) ⭐ 6 | 🐛 2 | 🌐 Go | 📅 2026-09-04 - Type-Safe stubs code generator for your AuthZed schemas
* .NET
...
* [gitpod-io/gitpod](https://github.com/gitpod-io/gitpod) ⭐ 13,766 | 🐛 451 | 🌐 TypeScript | 📅 2026-09-07 - GitPod's support for fine-grained authorization leverages SpiceDB
* [wolfi-dev/os](https://github.com/wolfi-dev/os/blob/main/spicedb.yaml) ⭐ 1,286 | 🐛 84 | 🌐 Shell | 📅 2026-09-08 - Container build toolchain that packages SpiceDB
* [raystack/frontier](https://github.com/raystack/frontier) ⭐ 343 | 🐛 41 | 🌐 Go | 📅 2026-09-08 - Cloud-native, role-based user management system and authorization server for your applications and API endpoints
* [infratographer/permissions-api](https://github.com/infratographer/permissions-api) ⭐ 11 | 🐛 38 | 🌐 Go | 📅 2026-09-07 - The default authorization strategy for Infratographer leverages SpiceDB
